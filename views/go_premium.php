		...
		<div class="container">
			...
			<nav id="nav">
				<ul>
					...
					<li class="active"><a class="icon solid fa-dollar-sign" href="go_premium.php"><span>Go premium </span></a></li>
			...
			<div class="row">
				...
				<div id="sidebar" class="col-4 col-12-medium">
					...
					<article class="box post">
						...
						<ul class="actions">
							<li><a href="application_details.php" class="button icon solid fa-file">Learn More</a></li>
						</ul>
					</article>
