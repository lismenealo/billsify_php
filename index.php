...
<div id="page-wrapper">
    ...
    <section id="header">
        <div class="container">
            ...
            <nav id="nav">
                <ul>
                    <li class="active"><a class="icon solid fa-home" href="index.php"><span>Home</span></a></li>
                    <li><a class="icon solid fa-cogs" href="views/application_details.php"><span>Application Details</span></a></li>
                    <li><a class="icon solid fa-dollar-sign" href="views/go_premium.php"><span>Go premium </span></a></li>
                    <li><a class="icon solid fa-mail-bulk" href="views/contact.php"><span>Contact Us</span></a></li>
                </ul>
            </nav>
            ...
            <div class="row">
                <div class="content col-8 col-12-medium">
                    ...
                    <article class="box post">
                        ...
                        <ul class="actions">
                            <li><a href="views/application_details.php" class="button icon solid fa-file">Learn More</a></li>
                        </ul>
                    </article>
            ...
            <div class="row">
                ...
                <div class="content col-8 col-12-medium">
                    ...
                    <article class="box post">
                        ...
                        <ul class="actions">
                            <li><a href="views/go_premium.php" class="button icon solid fa-file">go_premium</a></li>
                        </ul>
                    </article>
    ...
    <section id="footer">
        <div class="container">
            <header>
                <h2>Questions or comments? <strong>Get in <a href="views/contact.php">touch:</a></strong></h2>
            </header>
            <div class="row">
                <div class="col-12 col-12-medium">
                    <section>
                        <h2 class="hidden">Contact us</h2>
                        <p>Get in contact with us <a href="views/contact.php">here</a> or via social media</p>
                        <div class="row">
                            <div class="col-6 col-12-small">
                                <ul class="icons">
                                    ...
                                    <li class="icon solid fa-envelope">
                                        <a href="views/contact.php#">info@billsify.com</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-6 col-12-small">
