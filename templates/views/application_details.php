    ...
    <div class="container">
        ...
        <div class="row aln-center">
            ...
            <div class="col-12">
                <!-- Feature -->
                <section>
                    <a href="application_details" class="image featured"><img src="images/OCR-Animation-Low-Quality-Image-540px-opt.gif" alt="Bill's details iOS Application" /></a>
                    <header>
                        <h3>OCR for captured <i>₿</i>ills</h3>
                    </header>
                    <p><strong>Metadata</strong> to classify your captured <strong>₿ills</strong> will be automatically generated using OCR</p>
            ...
            <div class="col-12">
                <ul class="actions">
                    <li><a href="go_premium" class="button icon solid fa-file">Go Premium</a></li>
                </ul>
            </div>
        </div>
    </div>
